...
const sampleData = {
  ...
  entities: [
    ...
    { id: "q-hearth", kind: "quest", name: "Keep the Hearth Lit", intro: 4, questBadge: "World", timeLimit: "Until the winter breaks", achievements: ["First Innkeeper"], failure: "The Inn loses its licence and Lex loses the deed.", description: "Hold the Midnight Inn open through the whole of the first winter. Three tasks make up the chain." },
    { id: "q-stock", kind: "quest", name: "Stock the Cellar", intro: 4, timeLimit: "Seven days", description: "Fill the Inn's cellar before the roads close." },
    { id: "q-cook", kind: "quest", name: "Find a Cook", intro: 8, failure: "The kitchen stays shut for a month.", description: "Hire someone who can feed a full house." },
    ...
    { id: "q-envoy", kind: "quest", name: "Answer the Jotun Envoy", intro: 26, questBadge: "Hidden", achievements: ["Spoken For"], failure: "The Jotun Empire marks the Inn as hostile.", description: "Meet Envoy Luthor without giving the Inn away. Nobody was told this quest existed." },
    ...
    { id: "q-anomaly", kind: "quest", name: "Investigate the anomaly in the Azure Mortal Realm", intro: 20, questBadge: "Urgent", description: "Find whatever is bending the realm's edges. The terms of this one grew as the story turned — the objectives below were added chapter by chapter, not split into new quests." },
    { id: "q-caravan", kind: "quest", name: "Bring the Stonevale Caravan Through", intro: 28, description: "Lex and Vane are told to get the caravan across the pass together. Their systems are not the same and neither is their share of the work." },
...
function questCardHtml(run,derived,children,depth){
  ...
  const open=expandedQuests.has(run.quest),partsOpen=openQuestChains.has(run.quest),
